...
const Login  = ()=>{
    ...
    const handleKakaoCallback = async (code) => {
        try {
            ...
            console.error("카카오 로그인 후 처리 중 오류 발생", error);
        }
    };
